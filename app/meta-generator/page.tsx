...
export default function MetaGeneratorPlaceholder() {
  return (
    <div className="max-w-xl mx-auto py-12 space-y-6 text-center animate-in fade-in-50 duration-300">
      ...
      <div className="bg-card border border-border rounded-2xl p-8 shadow-sm flex flex-col items-center justify-center space-y-5">
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-xl font-bold tracking-tight">Meta Tags Optimizer & Generator</h2>
          <p className="text-sm text-muted-foreground leading-relaxed max-w-sm mx-auto">
            Audit meta title tags, meta descriptions, Open Graph protocol data, and review SERP desktop/mobile card previews in real-time.
          </p>
        </div>
